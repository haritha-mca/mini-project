...
<head>
    ...
    <title>Doctor Dashboard - MedAlert Access System</title>
...
<body>
    <nav>
        ...
        <a href="doctor_view_details.php">View Patient Details</a>
        <a href="add_patient_details.php">Add Patient Details</a>
        <a href="doctor_view_feedback.php">Feedback View</a>
        <a href="logout2.php">Logout</a>
    </nav>
    <div class="content">
        <header>
            <h1>Doctor Dashboard - MedAlert Access System</h1>
        </header>
        <main>
            <div class="welcome-message">
                Welcome!
            </div>
            <img src="assets/images/health record.webp" alt="Dashboard Image" class="dashboard-image">
