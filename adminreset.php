...
if (isset($_POST['change'])) {
    ...
    // Query to update password in the users (admin) table
    $query = mysqli_query($con, "UPDATE admins SET password='$newpassword' WHERE username='$username' AND email='$email'");
...
<html lang="en">
<head>
    <title>MedAlert Access System | Admin Reset Password</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="logo">
            <h2>MedAlert Access System | Admin Reset Password</h2>
        </div>
        <form name="passwordreset" method="post" onSubmit="return valid();">
            <fieldset>
                <legend>Admin Reset Password</legend>
